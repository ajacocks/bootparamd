...
Source: http://ftp.linux.org.uk/pub/linux/Networking/netkit/netkit-%{name}-%{version}.tar.gz
...
perl -pi -e '
    ...
    s,^LDFLAGS=,LDFLAGS=-pie -ltirpc,;
    s,^CFLAGS=,CFLAGS=-I/usr/include/tirpc ,;
    ' MCONFIG
%ifarch s390 s390x 
export f_PIE="-fPIE"
%else
...
%changelog
* Thu Jan 07 2021 Alexander Jacocks <alexander@redhat.com> - 0.17-47
- update build to use libtirpc

* Mon Feb 20 2017 Lukáš Nykrýn <lnykryn@redhat.com> - 0.17-46
- build requires perl

* Fri Feb 10 2017 Fedora Release Engineering <releng@fedoraproject.org> - 0.17-45
- Rebuilt for https://fedoraproject.org/wiki/Fedora_26_Mass_Rebuild

* Wed Feb 03 2016 Fedora Release Engineering <releng@fedoraproject.org> - 0.17-44
